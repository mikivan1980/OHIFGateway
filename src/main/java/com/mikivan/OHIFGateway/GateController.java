...
public class GateController {
    ...
    public ResponseEntity<String> getStudylist(
        ...
        //log.info("/mikivan/studies?<RequestParam>");

        //выводим параметры запроса пришедшие с meteor
        //log.info("RequestParam: " + queryMap.toString() );
...
//StudyDate
        ...
        for( Map.Entry<String, String> entry : queryMap.entrySet() ){
            ...
            if(  (!entry.getKey().equals("limit")) &&
                ...
                test.add("-m");test.add(entry.getKey() + "=" + entry.getValue());
...
//         test.add("-r");test.add("00081030");
        ...
        test.add("--xsl");test.add("xslt/mikivan-studies.xsl");
        test.add("-K");
        test.add("-I");
