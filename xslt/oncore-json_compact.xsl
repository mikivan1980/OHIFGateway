...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:template match="/NativeDicomModel">
        <xsl:text>{</xsl:text>
        <xsl:apply-templates mode="dcm4che" select="DicomAttribute"/>

        <!--<xsl:text>,"00081190":{"vr":"UR", "Value":["http://127.0.0.1/dicom-web/studies/</xsl:text>-->
    ...
    <xsl:template match="DicomAttribute" mode="mikivan">
        ...
        <xsl:choose>
            ...
            <xsl:when test="@tag='0020000D'">
                <xsl:text>,"00081190</xsl:text>
                <xsl:text>":{"vr":"UR"</xsl:text>
    ...
    <xsl:template match="DicomAttribute" mode="dcm4che">
    ...
    <xsl:template match="Value" mode="mikivan">
        ...
        <xsl:if test="position()=1">"Value":[</xsl:if>
            ...
            <xsl:text>"http://127.0.0.1/dicom-web/studies/</xsl:text>
